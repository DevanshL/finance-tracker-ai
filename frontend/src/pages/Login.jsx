...
function Login() {
  ...
  try {
    ...
    if (response && response.token) {
      ...
      // ✅ FORCE NAVIGATE - This bypasses React Router issues
      ...
      // Option 2: Or use React Router navigate (if above doesn't work)
      // setTimeout(() => {
        ...
        <div className="relative h-full flex flex-col items-center justify-center p-12 text-white">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-md mx-auto">
              Track expenses, set budgets, achieve goals, and get AI-powered insights to improve your financial health.
            </p>
            <div className="flex items-center justify-center gap-8 pt-8">
              ...
              <div className="text-center">
                ...
                <div className="text-white/80">Managed</div>
              </div>
              <div className="w-px h-16 bg-white/30"></div>
              <div className="text-center">
